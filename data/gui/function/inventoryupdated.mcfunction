...
# lvl20 - Bow and Arrow
execute as @s[tag=inRun,scores={level=20}] run item replace entity @s hotbar.0 with bow[max_stack_size=1,custom_name={"color":"aqua","italic":false,"text":"The Bow"},lore=[{"color":"gray","italic":false,"text":"You should know how to use this."}],unbreakable={},enchantment_glint_override=false,enchantments={"minecraft:infinity":1},tooltip_display={hidden_components:["enchantments","unbreakable"]}] 1
...
# lvl45 - TNT (sometimes)
execute if entity @s[tag=hasTnt] run function mechanics:tnt/givetnt
# lvl46 - Shrink Guy
execute as @s[tag=inRun,scores={level=46}] run item replace entity @s hotbar.4 with flow_banner_pattern[max_stack_size=1,custom_name={"color":"aqua","italic":false,"text":"Shrink Machine"},lore=[{"color":"gray","italic":false,"text":"Click to Shrink"}],consumable={consume_seconds:100000,animation:"none",has_consume_particles:false}] 1
