...
execute if score @s inventoryState matches 1 run item replace entity @s hotbar.8 with red_concrete[max_stack_size=1,custom_name='{"color":"red","italic":false,"text":"Exit Level"}',lore=['{"color":"gray","italic":false,"text":"Click to restart current level"}'],food={nutrition:0,saturation:0,can_always_eat:true,eat_seconds:1000000}] 1
