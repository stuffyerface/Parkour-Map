...
execute as @e[type=block_display,tag=snake_block] at @s if score @s snake matches 0 run setblock ~ ~ ~ barrier strict
...
execute as @e[type=block_display,tag=snake_block] at @s if score @s snake matches 22 run setblock ~ ~ ~ air strict
