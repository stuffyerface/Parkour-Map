...
execute as @e[type=marker,tag=new,tag=breakable_wall] at @s run setblock ~ ~ ~ cracked_stone_bricks strict
execute as @e[type=marker,tag=new,tag=breakable_wall] run tag @s remove new

kill @e[type=bat,tag=breakable_wall]

execute as @e[type=bat,tag=switch_blue] at @s run summon marker ~ ~-1 ~ {Tags:["switch_blue"]}
execute as @e[type=bat,tag=switch_red] at @s run summon marker ~ ~-1 ~ {Tags:["switch_red"]}
...
execute as @e[type=bat,tag=falling_block] at @s run setblock ~ ~-1 ~ yellow_glazed_terracotta strict
...
execute as @e[type=bat,tag=spawn_tnt] at @s run summon text_display ~ ~ ~ {alignment:"center",billboard:"vertical",shadow:1b,Tags:["tnt_pile"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,.55f,0f],scale:[1f,1f,1f]},text:{"color":"red","text":"Click to Pickup TNT"}}
...
execute as @e[type=bat,tag=appearingBlock] at @s run setblock ~ ~-1 ~ gray_glazed_terracotta strict
